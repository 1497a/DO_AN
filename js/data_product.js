    ...
    if (product_order) {
        ...
        Object.values(product).map((item, index) => {
            if (index >= start && index < end) {
                ...
                html += '<a href="../admin/form_edit_product.html" id =' + item.code + '>' + '<button class="btn btn-primary btn-sm edit" onclick="getItemEdit(this);"type="button" title="Sửa" id="show-emp" data-toggle="modal" data-target="#ModalUP">' + '<i class="fas fa-edit">' + '</i>' + '</button>' + '</a>';
                html += '</td>';
                html += '</tr>';
            }
        })
